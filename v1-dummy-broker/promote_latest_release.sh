...
./generate_deployment_manifest aws /workspace/deployments-runtime/$RELENG_ENV/cf-aws-stub.yml /workspace/deployments-runtime/$RELENG_ENV/cf-shared-secrets.yml > deployment.yml
