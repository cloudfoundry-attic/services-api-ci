...
./generate_deployment_manifest aws /workspace/deployments-core-services/$RELENG_ENV/cf-aws-stub.yml /workspace/deployments-core-services/$RELENG_ENV/cf-shared-secrets.yml /workspace/deployments-core-services/$RELENG_ENV/v1-dummy-broker-secrets.yml > deployment.yml
