...
./generate_deployment_manifest aws /workspace/deployments-core-services/$RELENG_ENV/cf-aws-stub.yml /workspace/deployments-core-services/$RELENG_ENV/cf-shared-secrets.yml > deployment.yml
